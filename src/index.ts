...
app.post('/extract-asset', async (req, res) => {
    try {
        ...
        const { artistName, songName, numberOfCopies, coverArtURL, collaboratorUsers, isReleasedByArtist } = req.body;

        const style = `<html><head><style>
                            ...
                            * {
                            ...
                            .upper-body {
                                background-image: url(${coverArtURL});
                            ...
                            .num-copies p:first-child {
                                line-height: 1;
                                font-size: 103px;
                                font-weight: 500;
                                text-align: right;
                            }
                            .num-copies p:last-child {
                                line-height: 1;
                                font-size: 25px;
                            ...
                            .artist-info img:not(:first-child),
                            .artist-info-more img:not(:first-child) {
                                margin-left: -28px;
                            }
                            .artist-profile-pic {
                                width: 100px;
                        ...
                        `;
        const upperBody = `<div class="asset-container">
                                <div class="upper-body">
                                    <div class="upper-intro">
                                        <div class="info-div">
                                            <div class="top-header">
                                                <p class="mint-text">GET YOURS NOW</p>
                                            ...
                                            <div class="bottom-header">
                                                <h1>
                                                    Check out ${isReleasedByArtist ? 'my' : 'this'}
                                                    <br />
                                                    new Music NFT!
                                                </h1>
                                            </div>
                                ...
                                <div class="lower-body">
                                    ...
                                    <div class=${collaboratorUsers.length <= 2 ? 'artist-info' : 'artist-info-more'}>
                                        <div class="artist-profile-pics">
                                            ${collaboratorUsers.map(
                                                (collaborator: any, index: any) =>
                                                    `<img src=${collaborator.avatar} key=${index} class="artist-profile-pic" />`,
                                            )}
                                        </div>
                                        <div class="artists">
                                            <p class="song-by">Song by</p>
                                            <div class="artist-name">
                                                ${collaboratorUsers.map(
                                                    (collaborator: any, index: any) =>
                                                        `<p key={index}>
                                                            ${collaborator.name}
                                                            ${index !== collaboratorUsers.length - 1 ? ',' : ''}&nbsp;
                                                        </p>`,
                                                )}
                                            </div>
                                        </div>
                                    ...
                                    <div class="footer">
                                        ...
                                        <p>
                                            ...
                                            <br />
                                            The artist appreciates your support and has put together self-curated items exclusively for you.
                                        </p>
                                    </div>
                                </div>
                            </div>
